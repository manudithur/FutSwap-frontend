...
<template>
    <div class="bg">
        <v-toolbar app flat height="72px" elevation="1">
            <v-toolbar-title>
                <router-link to="/explorar" style="text-decoration: none;">
                    <v-img lazy-src="" max-height="64" max-width="96" src="../assets/FutSwap.png">
                    </v-img>
                </router-link>
            </v-toolbar-title>
            <v-spacer></v-spacer>
            <v-toolbar-items>
                <v-btn v-for="item in menuItems" :key="item.title" :to="item.path" plain color="#3E4D7C">
                    {{ item.title }}
                    <v-icon>
                        {{item.logo}}
                    </v-icon>
        ...
        <v-app id="inspire" class="transparent">
            <v-main class="py-4">
                <v-container class="elevation-1" style="background-color: white; border-radius: 4px;">
                    <v-row>
                        <v-card width="100%">
                        ...
                        <v-data-table style="width: 100%;" :headers="headers" :items="swaps" sort-by="date" sort-desc>
                            ...
                            <v-dialog v-model="dialog" max-width="500px">
                                <v-card>
                                    ...
                                    <v-card-actions>
                                        <v-spacer></v-spacer>
                                        <v-btn color="#3E4D7C" text @click="close">
                                            Cancel
                                        </v-btn>
                                        <v-btn color="#3E4D7C" text @click="save">
                                            Save
                                        </v-btn>
                                    </v-card-actions>
                                </v-card>
                            ...
                            <v-dialog v-model="dialogReport" max-width="500px">
                                <v-card>
                                    ...
                                    <v-card-actions>
                                        <v-spacer></v-spacer>
                                        <v-btn color="#3E4D7C" text @click="closeReport">Cancelar</v-btn>
                                        <v-btn color="#3E4D7C" text @click="ReportConfirm">OK</v-btn>
                                        <v-spacer></v-spacer>
                                    </v-card-actions>
                                </v-card>
                            </v-dialog>
