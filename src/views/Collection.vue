  ...
  <v-app id="inspire">
      ...
      <v-app-bar app>
          ...
          <router-link to="/landing" style="text-decoration: none;">
              <v-img lazy-src="" max-height="100" max-width="120" src="../assets/FutSwap.png">
              </v-img>
          </router-link>
          </v-toolbar-title> -->
          <v-toolbar-title>
              <router-link to="/landing" style="text-decoration: none;">
                  <img :src="require('../assets/FutSwap.png')" height="80"/>
              </router-link>
          </v-toolbar-title>
          <v-spacer></v-spacer>
          <v-toolbar-items>
      ...
      <v-main class="bg">
          <v-container class="pa-0">
              ...
              >
                  ...
                  >
                  <v-card-title class="justify-center text-uppercase" style="text-shadow: 0px 2px 16px #000000"><h1>Your Collection</h1> </v-card-title>
                  </v-img>
              </v-card>
              <v-row>
                  ...
                  >
                      <v-dialog v-model="dialog" width="600">
                          <template v-slot:activator="{ on, attrs }">
                              <v-card class="grow" :elevation="20" v-bind="attrs" v-on="on">
                          ...
                          <v-card class="overflow-hidden"> 
                              ...
                              <v-col cols="7" class="pr-6 d-flex flex-column">
                                <h2 class="pt-4 text-center text-uppercase" style="color:#666666">Your Figuritas</h2>

                                <!-- <button @click="{j.count}++">+</button> -->
                                <div class="text-center ma-auto" style="color:#333333; font-size: 8rem;">{{j.count}}</div>
