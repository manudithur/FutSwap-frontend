        ...
        <v-card>
          <v-row class="justify-center">
            <v-card-title class="text-center">
              <h1 class="display-2 font-weight-bold pt-5" style="color:rgb(62,77,124)">Felicidades por usar nuestra app para tradear</h1>
              <h2 class="display-2 font-weight-bold pt-5" style="color:rgb(62,77,124)">Debajo esta la informacion del trade que acaba de realizar</h2>
            </v-card-title>
          </v-row>
          <v-row class="justify-center pt-2 ">
            <v-col cols="5">
              <v-card class="pt-5" elevation="0">
                <v-card-title  class="text-center justify-center">
                  <h4 class="display-1 font-weight-regular pt-5" style="color:rgb(62,77,124)">Lo que recibiste</h4>
                </v-card-title>
                <v-list>
            ...
            <v-col cols="5">
              <v-card class="pt-5" elevation="0">
                <v-card-title  class="text-center justify-center">
                  <h4 class="display-1 font-weight-regular pt-5" style="color:rgb(62,77,124)">Lo que ofertaste</h4>
                </v-card-title>
                <v-list>
                  <v-list-item-group multiple class="pa-5">
